...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { first_name: @professor.first_name, last_name: @professor.last_name, office_id: @professor.office_id } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { first_name: @professor.first_name, last_name: @professor.last_name, office_id: @professor.office_id } }
